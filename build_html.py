...
<div class="page">
  <div class="download-bar">
    ...
    <a class="download-btn" href="output/cv.md" download>
    ...
    <button class="download-btn" onclick="showMarkdown()" aria-label="View Markdown">
      <svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z"/></svg>
      <span class="btn-label">View MD</span>
    </button>
